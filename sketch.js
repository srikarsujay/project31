...
function draw() {
  ...
  box2.display("blue", "pink");
  box3.display("blue", "pink");
  box4.display("blue", "pink");
  box5.display("blue", "pink");
  box6.display("lightgreen", "pink");
  box7.display("lightgreen", "pink");
  box8.display("lightgreen", "pink");
  box9.display("lightgreen", "pink");
  box10.display("lightpink", "pink");
  box11.display("lightpink", "pink");
  box12.display("lightpink", "pink");
